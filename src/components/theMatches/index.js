...
class TheMatches extends Component {
  ...
  componentDidMount() {
    firebaseMatches.once("value").then(snapshot => {
      ...
      this.setState({
        ...
        filtereMatches: matches.reverse()
      });
    });
  }
  showPlayed = played => {
    ...
    this.setState({
      filtereMatches: played === "All" ? this.state.matches : list,
      playedFilter: played,
      resultFilter: "All"
    });
  };
  ...
  showResult = result => {
    ...
    this.setState({
      filtereMatches: result === "All" ? this.state.matches : list,
      playedFilter: "All",
      resultFilter: result
    });
  };
      ...
      <div className="the_matches_container">
        <div className="the_matches_wrapper">
          <div className="left">
            ...
            <MatchesList matches={state.filtereMatches} />
          </div>
          <div className="right">
            <LeagueTable />
          </div>
